const EXAMPLES = [
  {
    ...
    highlight: 0,
    status: 'correct',
    title: 'Kesk = tîp rast e, û cihê wê jî rast e',
    desc: '"k" di peyvê de heye û di cîhê yekem de ye.',
  },
  {
    letters: ['b', 'a', 'r', 'a', 'n'],
    highlight: 1,
    status: 'present',
    title: 'Zer = tîp heye di peyvê de, lê cihê wê ne rast e',
  ...
  },
  {
    ...
    highlight: 2,
    status: 'absent',
    title: 'Gewr = tîp ne di peyvê de ye',
